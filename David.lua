...
os.execute('wget https://raw.githubusercontent.com/David-Team-Rio/halowen/master/David.lua') 
dofile('David.lua') 
...
--     Source David     --
if text == "مودي" or text == "يماش" or text == "ياماش" then 
Text = [[
@zBzzz
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝖸𝖺 .',url="t.me/zbzzz"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/zbzzz&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source David     --
